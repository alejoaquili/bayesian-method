import numpy as np
from utils.data_loader import load_person_preferences, load_news_dataset, transform_news_dataset
...
transform_news_dataset(news_data, ["Internacional", "Deportes", "Ciencia y Tecnología", "Economía"], "../output/transformed_news.csv")
